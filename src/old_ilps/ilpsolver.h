...
protected:
  ...
  /// Gurobi model
  GRBModel _model;
  /// Variable x[i][s] = 1 iff vertex v_i is labeled by anatomical site s
  VarMatrix _x;
  /// Variable y[ij] = 1 iff edge (v_i, v_j) is a migration edge
  VarArray _y;
  /// Variable z[ij][s] = 1 iff v_i and v_j are labeled by anatomical site s
  VarMatrix _z;
