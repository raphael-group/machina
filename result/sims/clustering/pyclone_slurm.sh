...
do
    ...
    do
        ...
        do
            ...
            echo "PyClone run_analysis --config_file config.yaml" >> $f
            echo "PyClone build_table --burnin 1000 --config_file config.yaml --out_file clustering.tsv --table_type loci" >> $f
        done
    done
done
